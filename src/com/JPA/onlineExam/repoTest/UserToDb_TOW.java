...
//		User user8 = new User();
		...
		user1.setTestPaperList(new HashSet<>(TestPaperList));
		user1.setAttemptTestPaperList(new HashSet<>(attemptTestPaperList));
		user1.setTopicWiseScoreList(new HashSet<>(TopicWiseScoreList));
		...
		user2.setTestPaperList(new HashSet<>(TestPaperList));
		user2.setAttemptTestPaperList(new HashSet<>(attemptTestPaperList));
		user2.setTopicWiseScoreList(new HashSet<>(TopicWiseScoreList));
...
//		 user2.setFriends(friends);
		...
		user3.setTestPaperList(new HashSet<>(TestPaperList));
		user3.setAttemptTestPaperList(new HashSet<>(attemptTestPaperList));
		user3.setTopicWiseScoreList(new HashSet<>(TopicWiseScoreList));
